...
// //       fee?: BigNumber; // todo contract fixture format
// //     }
// //   ): Promise<
...
// //         },
// //         supplier: { removalDataToList: options?.removalDataToList },
// //       },
...
//       const { bpNori, fifoMarket, hre, userFixtures, fee } = await setupTest({
//         userFixtures: {
//           supplier: {
...
//             removalDataToList,
//           });
//         const purchaseAmount = formatTokenAmount(
//           add(removalDataToList[0].amount, removalDataToList[1].amount) // purchase first two removals
//         );
...
//       const { bpNori, certificate, fifoMarket, hre, fee } =
//         await setupTestLocal({
//           buyerInitialBPNoriBalance,
...
//         buyerInitialBPNoriBalance.sub(totalPrice)
//       );

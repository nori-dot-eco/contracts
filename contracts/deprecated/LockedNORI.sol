 ...
 * @author Nori Inc.
 *
 * @notice This source is retained exclusively for the purposes of testing the upgrade path
 * from LockedNORI to LockedNORIV2. This source is needed for the openzeppelin upgrades plugin to function.
 *
  ...
  ERC777PresetPausablePermissioned
{
   ...
   */
  IERC777Upgradeable private _bridgedPolygonNori;

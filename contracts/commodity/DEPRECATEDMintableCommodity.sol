...
contract DEPRECATEDMintableCommodity is DEPRECATEDCommodityAuthority, IMintableCommodity {
    ...
    function mint(address _to, bytes _operatorData, uint256 _value, bytes _misc) public returns(uint64) {
        ...
        if (recipientImplementation != 0) {
            ...
            emit InsufficientPermission(msg.sender, _operatorData, _value, _misc);
            revert();
        }

...
import "./DEPRECATEDCommodityAuthority.sol";
...
contract DEPRECATEDVerifiableCommodity is DEPRECATEDCommodityAuthority, IVerifiableCommodity {
    ...
    function verify(uint256 _commodityId, bytes _verifierData, uint64 _category) public {
        ...
        if (recipientImplementation != 0) {
            ...
            emit InsufficientPermission(msg.sender, _commodityId, _verifierData, _category);
            revert();
        }

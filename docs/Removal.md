...
```solidity
event RegisterContractAddresses(contract IMarket market, contract ICertificate certificate)
```
...
| ---- | ---- | ----------- |
| market | contract IMarket | The address of the new market contract. |
...
```solidity
function registerContractAddresses(contract IMarket market, contract ICertificate certificate) external
```
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| market | contract IMarket | The address of the Market contract. |
...
- If the recipient is neither the Market nor the Certificate the amount may also be zero.</i>
